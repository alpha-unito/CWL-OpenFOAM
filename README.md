...
The lid-driven [cavity](https://develop.openfoam.com/committees/hpc/-/tree/develop/incompressible/icoFoam/cavity3D) flow, where the motion is induced by the upper boundary (lid) of the cavity, is one of the most basic and widely used benchmark test cases in CFD.
